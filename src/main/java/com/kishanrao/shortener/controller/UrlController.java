...
public class UrlController {
    ...
    @Operation(summary = "Shorten a URL", description = "Accepts a URL and optional alias/TTL. Requires authentication.", responses = {
    ...
    @Operation(summary = "Redirect to original URL", responses = {
    ...
    private UrlDto toPublicDto(UrlDto dto, HttpServletRequest request) {
        ...
        // Ensure baseUrl always ends with a slash for clean concatenation
        String base = baseUrl.endsWith("/") ? baseUrl : baseUrl + "/";
        String publicUrl = base + "s/" + code;
